...
const pool = mysql.createPool({
  ...
  database: process.env.DB_NAME || "toko_buku",
  ...
  try {
    ...
    if (users.length === 0) {
      ...
      await connection.execute(
        ...
        ["admin", "admin@tokobuku.com", hashedPassword, "+62812345678", "Jl. Buku No. 123, Jakarta", "admin"]
      );
    ...
    console.error(`   DB_NAME=${process.env.DB_NAME || "toko_buku"}\n`);
  }
};
