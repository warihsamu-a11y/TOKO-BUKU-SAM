...
export function CartProvider({ children }) {
  ...
  useEffect(() => {
    const savedToken = localStorage.getItem("toko_buku_token");
    const savedUser = localStorage.getItem("toko_buku_user");
  ...
  const login = async (username, password) => {
    ...
    try {
      ...
      localStorage.setItem("toko_buku_token", newToken);
      localStorage.setItem("toko_buku_user", JSON.stringify(userData));
  ...
  const logout = () => {
    ...
    setOrders([]);
    setCart([]);
    localStorage.removeItem("toko_buku_token");
    localStorage.removeItem("toko_buku_user");
  };
  ...
  const updateUser = async (userData) => {
    ...
    try {
      ...
      setUser(updatedUser);
      localStorage.setItem("toko_buku_user", JSON.stringify(updatedUser));
      return updatedUser;
    } catch (error) {
